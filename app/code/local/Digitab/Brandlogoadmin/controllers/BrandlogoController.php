...
class Digitab_Brandlogoadmin_BrandlogoController extends Mage_Adminhtml_Controller_action
{

	protected function _initAction() {
		$this->loadLayout()
			->_setActiveMenu('brandlogoadmin/items')
...

    {
        ...
        return Mage::getSingleton('admin/session')->isAllowed('brandlogo');
