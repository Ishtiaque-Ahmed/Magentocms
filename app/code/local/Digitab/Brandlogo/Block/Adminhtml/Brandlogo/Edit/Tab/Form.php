...
class Digitab_Brandlogoadmin_Block_Brandlogo_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
      ...
      $fieldset->addField('content', 'editor', array(
          'name'      => 'content',
          'label'     => Mage::helper('brandlogo')->__('Content'),
          'title'     => Mage::helper('brandlogo')->__('Content'),
