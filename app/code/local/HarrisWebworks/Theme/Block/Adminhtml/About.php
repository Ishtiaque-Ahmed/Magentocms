...
class Harriswebworks_Theme_Block_Adminhtml_About
    ...
    implements Varien_Data_Form_Element_Renderer_Interface
{
    ...
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $version  = Mage::helper('harriswebworks_theme')->getExtensionVersion();
...
<p>
<strong>Harriswebworks Theme Extension v$version</strong><br />
Sends email to admin after a review submitted.
</p>
<p>
Website: 
