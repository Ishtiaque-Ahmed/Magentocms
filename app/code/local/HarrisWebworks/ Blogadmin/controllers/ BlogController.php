...
class HarrisWebworks_ Blogadmin_ BlogController extends Mage_Adminhtml_Controller_action
{

	protected function _initAction() {
		$this->loadLayout()
			->_setActiveMenu(' blogadmin/items')
	...
	public function editAction() {
		...
		if ($model->getId() || $id == 0) {
			...
			$this->_addContent($this->getLayout()->createBlock(' blog/adminhtml_ blog_edit'))
				->_addLeft($this->getLayout()->createBlock(' blog/adminhtml_ blog_edit_tabs'));
    ...
    {
        $fileName   = ' blog.csv';
        $content    = $this->getLayout()->createBlock(' blog/adminhtml_ blog_grid')
            ->getCsv();
